    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                    ...
                    .requestMatchers(HttpMethod.POST, "/api/templates/review").hasRole("ADMIN")
                    .requestMatchers(HttpMethod.GET, "/api/templates/search").authenticated()
                    .requestMatchers(HttpMethod.GET, "/api/templates/*/versions").authenticated()
                    .requestMatchers(HttpMethod.GET, "/api/templates/*").authenticated()
                    .requestMatchers(HttpMethod.GET, "/api/templates/*/ratings").authenticated()
                    .requestMatchers(HttpMethod.POST, "/api/templates/import").authenticated()
                    .requestMatchers(HttpMethod.POST, "/api/templates/rate").authenticated()
